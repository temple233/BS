    ...
    <div>
        <table>
            <tr>
                ...
                <td>
                    <table border="2" bordercolor="red" Width="450px" Height="50px"><tr><td>
                           <asp:TextBox ID="SearchText" runat="server" Height="30px" Width="300px"></asp:TextBox>
                           <asp:DropDownList ID="DropDownList1" runat="server" Height="40px" Width="120px" Font-Size="X-Large">
                ...
                <td><asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/webimg/search.jpg"/></td>      
                <td><asp:Label ID="user_id" runat="server" Text=""></asp:Label></td>
            </tr>
        </table>
